...
- **Iterace po feedbacku z produkce:** kotvení ke středu stahovalo fotky na širokých monitorech k textu (prázdné okraje). Finální řešení: fotky kotvené k **okrajům viewportu** (původní full-width look) + strop šířky `min(pref, maxPx, calc((50+offset)vw − 400px))` — vnitřní hrana fotky matematicky nedosáhne na textový sloupec na žádné šířce. Ověřeno 2D kolizním měřením na 1280×800 (nejtěsnější bod) a vizuálně na 1920×1080.
